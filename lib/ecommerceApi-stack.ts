...
export class ECommerceApiStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: ECommerceApiStackProps) {
    ...
    const api = new apigataway.RestApi(this, "ECommerceApi", {
    ...
    const productsFetchIntegration = new apigataway.LambdaIntegration(
    ...
    const productsAdminIntegration = new apigataway.LambdaIntegration(
      props.productsAdminhHandler
    )
